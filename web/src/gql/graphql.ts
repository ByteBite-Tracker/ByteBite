...
export type CreateUserMutation = { __typename?: 'Mutation', createUser?: { __typename?: 'CreateUser', users?: { __typename?: 'UsersType', email: string, firstName: string, lastName: string, password: string, username: string } | null } | null };
